...
export class Department extends Component{
    ...
    refreshList(){
        fetch('http://localhost:5191/api/Department' )
    ...
    changeDepartmentLocation =(e)=>{
        this.setState({DepartmentLocation:e.target.value});
    }
    changeCreatedDate =(e)=>{
    ...
    editClick(dep){
        this.setState({
            ...
            DepartmentDescription:dep.DEPARTMENT_DESCRIPTION,
            DepartmentLocation:dep.DEPARTMENT_LOCATION,
    ...
    <tbody>
        ...
        {departments.map(dep=>
            <tr key={dep.DEPARTMENT_ID}>
                ...
                <button type="button"
                className="btn btn-light mr-1"
                onClick={()=>this.deleteClick(dep.DEPARTMENT_ID)}>
...
<div className="modal-content">
   ...
   <div className="modal-body">
       ...
       <div className="input-group mb-3">
        <span className="input-group-text">DepartmentLocation</span>
        <input type="text" className="form-control"
